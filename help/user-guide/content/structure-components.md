...
description: Utilizza i componenti struttura per i layout di e-mail, pagina di destinazione e frammenti. Trascina le colonne, imposta gli stili e configura la visualizzazione mobile in Marketo Optimizer.
...
![Trascinare una struttura nell&#39;area di lavoro](assets/content-design-add-structure.png){width="800" zoomable="yes"}
...
| ---- | ---- | ----- |
| ![Abilita contenuto condizionale](../assets/do-not-localize/toolbar-button-enable-conditional-content.png){width="40"} | Abilita contenuto condizionale | (E-mail e frammenti) Abilita le varianti condizionali per il componente. |
...
![Opzioni di visualizzazione per il componente struttura](assets/content-components-display-options.png){width="400" zoomable="yes"}
...
![Non impilare colonne su dispositivi mobili](assets/structure-component-settings-stack-columns.png){width="250"}
...
![Selettore colore di sfondo](assets/content-components-styles-background-color.png){width="300"}

#### [!UICONTROL Immagine di sfondo] {#background-image}

Sposta il selettore per attivare le impostazioni dell&#39;immagine di sfondo.

![Impostazioni immagine di sfondo del componente Struttura con selettore risorse](assets/structure-components-background-image-settings.png){width="250"}
...
![Anteprima posizionamento immagine di sfondo in un componente struttura](assets/structure-component-styles-background-image.png){width="250"}
...
| ![Abilita contenuto condizionale](../assets/do-not-localize/toolbar-button-enable-conditional-content.png){width="40"} | Abilita contenuto condizionale | (E-mail e frammenti) Abilita le varianti condizionali per la colonna. |
...
* **[!UICONTROL Immagine di sfondo]** - Sposta il selettore di attivazione/disattivazione per abilitare le impostazioni dell&#39;immagine di sfondo.
  ...
  ![Impostazioni immagine di sfondo colonna nel pannello Stili](assets/structure-components-background-image-settings.png){width="250"}
...
![Accedere ai livelli di contenuto](assets/content-design-layers.png){width="800" zoomable="yes"}
...
![Componenti colonna visualizzati nello spazio di progettazione visivo](assets/content-design-layers-column-select.png){width="800" zoomable="yes"}
