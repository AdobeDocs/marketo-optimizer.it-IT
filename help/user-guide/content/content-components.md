...
description: 'Progetta e-mail, pagine di destinazione e frammenti con componenti di contenuto: aggiungi pulsanti, testo, immagini, moduli e contenitori in Marketo Optimizer.'
...
1. Imposta **[!UICONTROL Tipo]** per il collegamento:
   ...
   * **Pagina di destinazione** - Scegliere questo tipo per selezionare una pagina di destinazione pubblicata nell&#39;istanza di Marketo Engage connessa <!-- Journey Optimizer B2B Edition (_Beta_) or -->.
     ...
     Per l&#39;opzione **[!UICONTROL Pagina di destinazione]**, selezionare la pagina di destinazione pubblicata. Fai clic sull&#39;icona _Seleziona pagina_ ( ![Mostra icona collegamenti](../assets/do-not-localize/icon-landing-page-select.svg) ) e [seleziona la pagina di destinazione pubblicata](./landing-pages.md#link-to-landing-page).
...
* **[!UICONTROL Seleziona risorsa]** - Scegli questo tipo per sfogliare e selezionare una risorsa immagine dalla libreria Assets [!DNL Marketo Optimizer].
...
* **[!UICONTROL Importa file multimediali]** - Scegliere questo tipo per selezionare un file dal sistema e importarlo nella libreria di risorse [!DNL Marketo Optimizer].
  ...
  ![Importa un file di immagine nella libreria di risorse](assets/email-designer-image-upload.png){width="450"}
...
1. Imposta **[!UICONTROL Tipo]** per il collegamento:
   ...
   * **[!UICONTROL Collegamento esterno]** - Scegliere questo tipo per utilizzare un URL standard come destinazione del collegamento.
     ...
     ![Definisci un collegamento esterno per un componente immagine](assets/component-button-link-options-external.png){width="250"}

   * **Pagina di destinazione** - Scegliere questo tipo per selezionare una pagina di destinazione pubblicata nell&#39;istanza di Marketo Engage connessa <!-- Journey Optimizer B2B Edition (_Beta_) or -->.

     Per l&#39;opzione **[!UICONTROL Pagina di destinazione]**, selezionare la pagina di destinazione pubblicata. Fai clic sull&#39;icona _Seleziona pagina_ ( ![Mostra icona collegamenti](../assets/do-not-localize/icon-landing-page-select.svg) ) e [seleziona la pagina di destinazione pubblicata](./landing-pages.md#link-to-landing-page).

     ![Definisci un collegamento a una pagina di destinazione per un componente immagine](assets/component-button-link-options-landing-page.png){width="250"}
...
1. Fai clic sullo strumento _Modulo_ nella barra degli strumenti del componente oppure utilizza le proprietà **[!UICONTROL Incorpora modulo]** a destra per selezionare il modulo pubblicato.
   ...
   ![Seleziona il modulo pubblicato](assets/content-design-add-form-properties.png){width="600"}
...
1. Se si desidera ignorare il tipo di **[!UICONTROL completamento]** predefinito per il modulo, modificare l&#39;impostazione in base ai requisiti della pagina o del modello.
   ...
   * **[!UICONTROL Pagina di destinazione]** - Scegli questa opzione per selezionare una pagina di destinazione di [!DNL Marketo Optimizer] o Marketo Engage come follow-up.
   ...
   * **[!UICONTROL URL esterno]** - Scegliere questa opzione per specificare qualsiasi URL come pagina di follow-up. Dopo che il visitatore ha inviato il modulo, il browser carica l’URL designato.
     ...
     ![Modifica l&#39;impostazione di completamento](assets/content-design-add-form-follow-up.png){width="280"}
