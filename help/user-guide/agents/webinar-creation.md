---
title: Creare e promuovere i webinar
description: Utilizza l’interfaccia di chat in Marketo Optimizer per pianificare un webinar, aggiungere co-host e relatori, creare percorsi di promozione e sviluppo e controllare la generazione di rapporti, il tutto in un linguaggio naturale.
keywords: 
role: User
...
![Avvia il flusso di lavoro di creazione del webinar tramite l&#39;interfaccia chat](./assets/webinar-create-start.png){width="700" zoomable="yes"}
...
1. Il riquadro chat mostra un elenco di controllo **Piano attività** e funziona tramite di esso: risolvere il programma, impostare il nome, l&#39;ora di inizio, l&#39;ora di fine, il fuso orario e la capacità, quindi confermare.
   ...
   ![Specificare il nome, la data e l&#39;ora del webinar nell&#39;interfaccia di chat](./assets/webinar-create-name-time.png){width="500" zoomable="yes"}
...
1. Nel riquadro chat sono elencate le **licenze** disponibili nel webinar, ad esempio un componente aggiuntivo ad alta capacità con il relativo valore di capacità, e viene richiesto quale utilizzare. Rispondere con la capacità desiderata, ad esempio *&quot;Utilizzare la capacità del webinar a 1000&quot;*
   ...
   ![Impostare la licenza del webinar in base alla capacità](./assets/webinar-create-license-capacity.png){width="500" zoomable="yes"}
...
1. L&#39;interfaccia chat offre quindi **azioni migliori**: _Progettare il webinar_, _Aggiungere un co-host_, _Aggiungere un relatore_, _Configurare percorsi promozionali_ e _Configurare il percorso di sviluppo post-webinar_.
   ...
   ![L&#39;interfaccia di chat mostra i migliori passaggi successivi per la creazione del webinar](./assets/webinar-create-next-steps.png){width="500" zoomable="yes"}
...
![Aggiungi un co-host webinar nell&#39;interfaccia chat](./assets/webinar-create-add-co-host.png){width="500" zoomable="yes"}
...
![Apri progettazione webinar Adobe Connect dall&#39;interfaccia chat](./assets/webinar-create-open-design.png){width="500" zoomable="yes"}
